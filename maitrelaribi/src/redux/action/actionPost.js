...
export const get_product = () => async (dispatch) => {
    try {
       await axios.get('http://164.92.233.115/api/GEtPost').then((res)=>{
...
export const add_product = (data) => async (dispatch) => {
    try {
        await axios.post('http://164.92.233.115/api/AddPoste',data)
        .then((res)=>{
...
export const update_product = (id,data) => async (dispatch) => {
    try {
       const res= await axios.put(`http://164.92.233.115/api/Update/${id}`,data)
...
export const delete_product = (id) => async (dispatch) => {
    try {
        await axios.delete(`http://164.92.233.115/api/DeletePost/${id}`)
        dispatch(get_product())
...
export const get_user = () => async (dispatch) => {
  try {
     await axios.get('http://164.92.233.115/api/getuser').then((res)=>{
